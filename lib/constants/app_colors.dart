...
abstract class AppColors {
  ...
  // Additional Colors
  static const grayscale70 = Color(0xFF78828A); // Grayscale
  static const strokeLight = Color(0xFFF6F6F6); // Light stroke
  // Off-white
  ...
  static const borderSecondary = Color(0xFFF0F0F0); // Light border

  // Shadow Colors
  static const shadowLight = Color(0x1A000000); // Light shadow (10% opacity)
  static const shadowMedium = Color(0x40000000); // Medium shadow (25% opacity)
  static const shadowDark = Color(0x80000000); // Dark shadow (50% opacity)

  // Figma Design System Colors
  // Greyscale
  static const greyscaleBlack3 = Color(0xFF0B1519);
  static const greyscaleBlack2 = Color(0xFF0E1C21);
  static const greyscaleBlack1 = Color(0xFF122329);
  static const greyscaleGrey1 = Color(0xFFE7E9EA);
  static const greyscaleGrey2 = Color(0xFFB8BDBF);
  static const greyscaleGrey3 = Color(0xFF899194);

  // Primary Colors
  static const primary = Color(0xFFD49A00);
  static const secondary = Color(0xFFFFB901);
  static const notificationRed = Color(0xFFFF1F0B);
}
